@echo off
rem ============================================================
rem  TBH Box - Guest provisioning
...
reg add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Run" /v TBHBoxAgent /t REG_SZ /d "powershell.exe -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -File C:\OEM\setup.ps1" /f
